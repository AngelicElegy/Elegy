<template>
  ...
  onMounted(() => {
    ...
    // 创建客厅
    let livingIndex = 0;
    let livingUrl = "./imgs/VRimgA//livingroom";
    ...
    let kitIndex = 3;
    let textureUrl = "./imgs/VRimgA//kitchen";
    ...
    let balconyIndex = 8;
    let balconyUrl = "./imgs/VRimgA//balcony";
    ...
    let hallwayIndex = 9;
    let hallwayUrl = "./imgs/VRimgA//corridor";
    ...
    let mainIndex = 18;
    let mainUrl = "./imgs/VRimgA//bedroom";
